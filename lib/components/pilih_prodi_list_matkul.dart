...
import 'package:iaunila/screens/matakuliah_screen.dart';
import 'components.dart';

class PilihProdiListMatkul extends StatefulWidget {
  final List<ProdiModel> prodis;
  const PilihProdiListMatkul({Key? key, required this.prodis}) : super(key: key);

  @override
  State<PilihProdiListMatkul> createState() => _PilihProdiListMatkulState();
}

class _PilihProdiListMatkulState extends State<PilihProdiListMatkul> {
        ...
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (BuildContext context) {
                  return MataKuliahScreen(idProdi: prodi.id_sms.toString(),);
                }
            )
        );
      },
