...
class PilihProdiListMahasiswa extends StatefulWidget {
  final List<ProdiModel> prodis;
  const PilihProdiListMahasiswa({Key? key, required this.prodis}) : super(key: key);

  @override
  State<PilihProdiListMahasiswa> createState() => _PilihProdiListState();
}

class _PilihProdiListState extends State<PilihProdiListMahasiswa> {
